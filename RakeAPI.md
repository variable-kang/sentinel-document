...
RakeAPI는 Log4j를 쓰고 있습니다. 외부 충돌을 고려하여 provided로 배포되고 있습니다. 따라서 사용하시는 프로젝트에 Log4j를 dependency를 넣지 않으시면 NPE가 발생합니다.
Log4j대신 다른 것들을 사용해 로깅을 하시더라도, log4j를 넣어주셔야 합니다.
